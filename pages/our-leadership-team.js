    ...
    return (
        <>
          ...
          `,
            ...
            <section id="rs-team" className='style2 solutionrow ptt-60 pbb-60 rs-team'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-2'></div>
                        <div className='col-sm-8'>
                            <h2 class="title mb-0 md-pb-20 h2call wow fadeInUp delay-0-2s animated animateUP pbb-30">Meet Our Leadership Team</h2>
                        </div>
                    </div>
                    <div className='row zindx'>
                        <div className='col-sm-2'></div>
                        <div className='col-sm-8 zindx'>
