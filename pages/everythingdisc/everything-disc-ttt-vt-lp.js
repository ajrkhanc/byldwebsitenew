...
export default function DiskTTTLP(){
    ...
    return(
        <>
          <Head>
            <title>Everything DiSC TTT VT LP - Everything DiSC</title>
            <meta name="description" content="Introducing DISC Virtual! Become a Certified DISC Trainer to Increase your confidence and create a culture of DISC in your organization As more and more organizations are experiencing the benefits of DISC"/> 
          </Head>
            ...
            <div className="container-full">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      <img className="img100" src="/edassets/img/banner/disk-ttt.jpg"/>
                    </div>         
                </div>
            </div>
            </div>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">
                    ...
                    <div className="col-lg-6 pr-0">
                        ...
                        <h4 className='countertoph2 text-left font24 pcdd'>Introducing DISC Virtual!</h4>                        
            ...
            <div className="container">
                <div className="row rs-vertical-middle">
                    ...
                    <div className="col-lg-12 pr-0">
                        ...
                        <p className='mall5 pcdd'><span className='themecolor font22 ptt-20'>Process of online training:</span></p>
                        <div className='rs-estimate'>                        
                        <ul className="estimate-info mtt-5">
                            ...
                            <li>Four virtual Classroom (2-hour session with a break) spread over 4 days.</li>
                        </ul>
                        </div>
                        ...
                        <b>PS:</b> By registering for this event, you are committing to one week of self-directed DISC Core content, plus three weeks dedicated to DISC Workplace. This deep dive includes three, live 90-minute, virtual instructor-led sessions..
                        </p>
